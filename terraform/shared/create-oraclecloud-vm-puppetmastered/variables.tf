...
variable "host_os_image" {
  # Install CentOS 7.x [default]
  #  + see https://docs.cloud.oracle.com/iaas/images/image/e090db79-477b-4d8b-92bc-f3485e6ed09d/
  default = "ocid1.image.oc1.uk-london-1.aaaaaaaabf2eslezq4wejiu3kq7zbbbmkw5k55eltwmpgpgzju2t7q3nlx7q"

  # Install Oracle 7.x in uk-london-1
  #  + see https://docs.cloud.oracle.com/iaas/images/image/cc839b42-1566-4d87-92c3-dbb5945299c7/
  # default = "ocid1.image.oc1.uk-london-1.aaaaaaaagwdcgcw4squjusjy4yoyzxlewn6omj75f2xur2qpo7dgwexnzyhq"
}
